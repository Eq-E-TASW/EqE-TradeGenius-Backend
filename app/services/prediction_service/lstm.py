...
from app.core.utility import get_historical_data_from_db


def get_historical_data(ticker):
    url = f"http://localhost:8007/historical-data/?ticker={ticker}&amount=3&unit=months&asset_type=stock"
...
def predict_with_lstm(ticker: str, db: Session, time_step=15, forecast_days=30):
